...
<head>
    ...
    <link href="{{ url('assets/css/main.8d288f825d8dffbbe55e.css') }}" rel="stylesheet">
</head>
...
<body>
                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                <div><b>Scope</b>
                                    <div class="page-title-subheading"><a href=""><b>Home</b></a> / Scope
                                    </div>
                                </div>
                            </div>
                            ...
                            <h2 class="accordion-header" id="flush-headingOne">
                                <div
                                    ...
                                    <a class="btn" style="padding:0 ;" data-bs-toggle="collapse"
                                        ...
                                        <h5 class="card-title">Add Scope</h5>
                                    </a>
                                </div>
                                    ...
                                    <div class="col-lg-8">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <!-- Criteria Form -->
                                                <form class="row g-3" action="{{ url('/scope/add') }}"
                                                    method="POST">
                                                    @csrf
                                                    <div class="col-12">
                                ...
                                <tbody>
                                    ...
                                    @forelse ($data['scope'] as $scope)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $scope['name'] }}</td>
                                            <td>
                                                <center><i class="fa fa-trash" style="margin-right:10px;"></i><i
                                                        class="fa fa-edit"></i></center>
                                            </td>
                                        </tr>
                                        @php
                                            $i++;
    ...
    <script type="text/javascript" src="{{ url('assets/scripts/main.8d288f825d8dffbbe55e.js') }}"></script>
</body>
